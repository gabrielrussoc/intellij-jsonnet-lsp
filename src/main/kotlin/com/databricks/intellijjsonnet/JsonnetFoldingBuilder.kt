...
import com.databricks.intellijjsonnet.psi.JsonnetArrcomp
import com.databricks.intellijjsonnet.psi.JsonnetObj
...
class JsonnetFoldingBuilder() : FoldingBuilderEx() {
    override fun buildFoldRegions(root: PsiElement, document: Document, quick: Boolean): Array<FoldingDescriptor> {
        ...
        val literalExpressions = PsiTreeUtil.findChildrenOfType<PsiElement>(
            root,
            com.databricks.intellijjsonnet.psi.JsonnetObj::class.java
        )
        literalExpressions.addAll(PsiTreeUtil.findChildrenOfType(root, com.databricks.intellijjsonnet.psi.JsonnetArr::class.java))
        literalExpressions.addAll(PsiTreeUtil.findChildrenOfType(root, com.databricks.intellijjsonnet.psi.JsonnetArrcomp::class.java))
